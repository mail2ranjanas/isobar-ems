...
Deployment 
===========
The elevatorms-1.0.war file needs to be deployed on Tomcat or any other Java compliant web server.
...
If tomcat is running on different port other than 8080, 
                         please update the port in ElevatorService.js (..\Tomcat 8.5\webapps\elevatorms-1.0\WEB-INF\classes\static\js\service\ElevatorService.js) file.
